...
const VisualDetectionView = forwardRef<HTMLDivElement, Props>(
	({ objects, opacity = 0.5, showCenter = false }, ref) => {
		return (
			<div
				ref={ref}
				style={{
			...
			>
				{objects.map((obj, index) => {
					return (
						// biome-ignore lint/suspicious/noArrayIndexKey: Detection objects don't have unique IDs
