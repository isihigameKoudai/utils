...
export const PoseDetectionView = forwardRef<HTMLVideoElement, PoseDetectionViewProps>(({ 
  width = 640,
  height = 480,
  poses
}, videoRef) => {
  ...
  useEffect(() => {
    (() => {
      if (!videoRef || !('current' in videoRef) || !videoRef.current || !canvasRef.current) return;
